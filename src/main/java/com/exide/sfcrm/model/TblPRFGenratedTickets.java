 ...
 */
@Entity
@Table(name = "tblprfgenratedtickets")
public class TblPRFGenratedTickets implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7313350873169039888L;
